/**
 * inpired by https://codepen.io/Gthibaud/pen/pyeNKj
 */
import React, { Component } from "react";
import PropTypes from "prop-types";

class TextParticle extends Component {
  componentDidMount() {
    const {
      text,
      gravity,
    ...
    configuration();
    var message = new shape(X, Y, text);

    message.getValue();
    update();
    window.onresize = function(params) {
      configuration();
      message = new shape(X, Y, text);
      message.getValue();
    };
