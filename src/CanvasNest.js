/**
 * inspired by https://github.com/hustcc/canvas-nest.js
 */
import React, { Component } from "react";
import PropTypes from "prop-types";

class CanvasNest extends Component {
  componentDidMount() {
    ...
    //创建画布，并添加到body中
    const { zIndex, opacity, color, count } = this.props;
    let the_canvas = this.effect, //画布
      config = {
        z: zIndex,
        o: opacity,
        c: color,
